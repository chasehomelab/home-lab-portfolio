...
| # | Project | Tools | Year |
|---|---------|-------|------|
| 1 | [Active Directory Lab](labs/01-active-directory/README.md) | Windows Server 2022, AD, PowerShell, Group Policy | 2025 |
| 2 | [SIEM Monitoring Lab](labs/02-splunk-siem/README.md) | Splunk Enterprise, SPL, Windows Server 2022, Kali | 2025 |
| 3 | [Vulnerability Scanning Lab](labs/03-vulnerability-scanning/README.md) | OpenVAS, Kali Linux, Metasploitable 2 | 2026 |
| 4 | [End-to-End Attack & Detection Lab](labs/04-attack-detection-capstone/README.md) | Kali, Metasploit, Splunk, Wireshark, OpenVAS | 2026 |
